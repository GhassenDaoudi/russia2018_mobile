...
public class StadesForm {
    ...
    public StadesForm() {
        ...
        for (Stade stade : LS) {
            ...
            Image i = URLImage.createToStorage(placeholder, stade.getImage(), "http://localhost/PI/image/" + stade.getImage(), URLImage.RESIZE_SCALE_TO_FILL);
            ...
            S1.addActionListener(ee -> {
                ...
                for (Match match : LMS) {
                    ...
                    Image i1 = URLImage.createToStorage(placeholder1, match.getE1().getDrapeau(), "http://localhost/PI/Flags/" + match.getE1().getDrapeau(), URLImage.RESIZE_SCALE_TO_FILL);
                    ImageViewer iv1 = new ImageViewer(i1);
                    Image i2 = URLImage.createToStorage(placeholder1, match.getE2().getDrapeau(), "http://localhost/PI/Flags/" + match.getE2().getDrapeau(), URLImage.RESIZE_SCALE_TO_FILL);
