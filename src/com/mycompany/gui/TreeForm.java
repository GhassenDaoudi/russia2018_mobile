...
public class TreeForm {
    ...
    public TreeForm() {
        ...
        for (Match match : LMD) {
            ...
            Image i3 = URLImage.createToStorage(placeholder1, match.getE1().getDrapeau(), "http://localhost/PI/Flags/" + match.getE1().getDrapeau(), URLImage.RESIZE_SCALE_TO_FILL);
            ImageViewer iv5 = new ImageViewer(i3);
            Image i4 = URLImage.createToStorage(placeholder1, match.getE2().getDrapeau(), "http://localhost/PI/Flags/" + match.getE2().getDrapeau(), URLImage.RESIZE_SCALE_TO_FILL);
