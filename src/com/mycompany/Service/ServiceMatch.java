...
public class ServiceMatch {
    ...
    public ArrayList<Match> getListMatchs() {
        ...
        con.setUrl("http://localhost/RS2018/web/matchs/all");
    ...
    public ArrayList<Evenement> getListEvents(int id_M) {
        ...
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/RS2018/web/matchs/allEvent/" + id_M);
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
                //listTasks = getListTask(new String(con.getResponseData()));
    ...
    public ArrayList<Match> getListMatchParGroupe(int id_G) {
        ArrayList<Match> listTasks = new ArrayList<>();
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/RS2018/web/matchs/allGroupe/" + id_G);
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
                //listTasks = getListTask(new String(con.getResponseData()));
    ...
    public ArrayList<Stade> getListStades() {
        ...
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/RS2018/web/matchs/allStades");
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
                //listTasks = getListTask(new String(con.getResponseData()));
    ...
    public ArrayList<Match> getListMatchStades(int id_S) {
        ArrayList<Match> listTasks = new ArrayList<>();
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/RS2018/web/matchs/allStadesM/" + id_S);
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
                //listTasks = getListTask(new String(con.getResponseData()));
    ...
    public ArrayList<Match> getPHFListMatch(String url) {
        ArrayList<Match> listTasks = new ArrayList<>();
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/RS2018/web/" + url);
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
                //listTasks = getListTask(new String(con.getResponseData()));
    ...
    public ArrayList<Equipe> getGagnant() {
        ...
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/RS2018/web/equipeG");
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
                //listTasks = getListTask(new String(con.getResponseData()));
    ...
    public ArrayList<Match> getFirstM() {
        ArrayList<Match> listTasks = new ArrayList<>();
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/RS2018/web/first");
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
                //listTasks = getListTask(new String(con.getResponseData()));
